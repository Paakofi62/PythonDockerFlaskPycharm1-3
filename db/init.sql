CREATE DATABASE IS218;
use IS218;

CREATE TABLE IF NOT EXISTS IS218_db (
    `LatD` INT
    `LatM` INT
    `Lats` INT
    `NS` VARCHAR(3) CHARACTER SET utf8
    `LonD` INT
    `LonM` INT
    `LonS` INT
...
INSERT INTO IS218_db VALUES
    ...
    (44	31	12	'"N"'	89	34	22	'"W"'	'"Stevens Point"'	'WI')
    ...
    (38	42	3	'"N"'	93	13	48	'"W"'	'"Sedalia"'	'MO')
